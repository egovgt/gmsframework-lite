...
//        }
     ...
     * in retrospect that's a pretty poor way to handle it.</p>
     *
     * @param dataToEncode byte array of data to encode in Base64Util form
    ...
    /**
     * Convenience method for reading a Base64Util-encoded
     ...
     * @return Base64Util-encoded string
     * @throws java.io.IOException if there is an error
     * @since 2.1
     */
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
         ...
         * Base64Util-encoded data in a stream.
         *
